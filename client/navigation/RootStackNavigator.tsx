...
export type RootStackParamList = {
  ...
  AdminEditOffre: { id: number; title: string; price: string; sellerCoupon: string; productUrl: string; info: string; country: string; currentPrice?: string; imageUrl?: string; offerType?: string; offer_type?: string; price3pcs?: string };
